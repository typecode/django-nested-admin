...
/* harmony import */ var _jquery_shim_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./jquery.shim.js */ "./nested_admin/static/nested_admin/src/nested-admin/jquery.shim.js");
/* harmony import */ var _jquery_shim_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _jquery_djangoformset__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./jquery.djangoformset */ "./nested_admin/static/nested_admin/src/nested-admin/jquery.djangoformset.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils */ "./nested_admin/static/nested_admin/src/nested-admin/utils.js");




_jquery_shim_js__WEBPACK_IMPORTED_MODULE_1___default()(document).ready(function () {
  // Remove the border on any empty fieldsets
  _jquery_shim_js__WEBPACK_IMPORTED_MODULE_1___default()('fieldset.grp-module, fieldset.module').filter(function (i, element) {
  ...
  _jquery_shim_js__WEBPACK_IMPORTED_MODULE_1___default()('input[name$="-DELETE"]:checked').not('[name*="__prefix__"]').closest('.djn-inline-form').addClass('grp-predelete');
  _jquery_shim_js__WEBPACK_IMPORTED_MODULE_1___default()(document).on('djnesting:initialized djnesting:mutate', function onMutate(e, $inline) {
    var $items = $inline.find('> .djn-items, > .tabular > .module > .djn-items');
    var $rows = $items.children('.djn-tbody');
    $rows.removeClass('row1 row2');
    $rows.each(function (i, row) {
      var n = 1 + i % 2;
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_1___default()(row).addClass('row' + n);
    });
  }); // Register the nested formset on top level djnesting-stacked elements.
  // It will handle recursing down the nested inlines.

  _jquery_shim_js__WEBPACK_IMPORTED_MODULE_1___default()('.djn-group-root').each(function (i, rootGroup) {
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_1___default()(rootGroup).djangoFormset();
  });
  _jquery_shim_js__WEBPACK_IMPORTED_MODULE_1___default()('form').on('submit.djnesting', function (e) {
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_1___default()('.djn-group').each(function () {
      _utils__WEBPACK_IMPORTED_MODULE_3__["default"].updatePositions(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_1___default()(this).djangoFormsetPrefix());
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_1___default()(document).trigger('djnesting:mutate', [_jquery_shim_js__WEBPACK_IMPORTED_MODULE_1___default()(this).djangoFormset().$inline]);
    });
  });
});
...
/* harmony import */ var _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./jquery.shim.js */ "./nested_admin/static/nested_admin/src/nested-admin/jquery.shim.js");
/* harmony import */ var _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _regexquote__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./regexquote */ "./nested_admin/static/nested_admin/src/nested-admin/regexquote.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils */ "./nested_admin/static/nested_admin/src/nested-admin/utils.js");
/* harmony import */ var grappelli__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! grappelli */ "grappelli");
/* harmony import */ var grappelli__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(grappelli__WEBPACK_IMPORTED_MODULE_6__);
...
function () {
  function DjangoFormset(inline) {
    ...
    this.$inline = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(inline);
    ...
    this._$template = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()('#' + this.prefix + '-empty');
    var inlineModelClassName = this.$inline.djnData('inlineModel');
    this.opts = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default.a.extend({}, this.opts, {
    ...
    _utils__WEBPACK_IMPORTED_MODULE_5__["default"].initRelatedFields(this.prefix, this.$inline.djnData());
    _utils__WEBPACK_IMPORTED_MODULE_5__["default"].initAutocompleteFields(this.prefix, this.$inline.djnData());
    ...
    this.$inline.find('.djn-group[id$="-group"][id^="' + this.prefix + '"][data-inline-formset]:not([id*="-empty"])').each(function () {
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(this)[pluginName]();
    });

    if (this.$inline.is('.djn-group-root')) {
      _utils__WEBPACK_IMPORTED_MODULE_5__["default"].createSortable(this.$inline);
    }

    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('djnesting:initialized', [this.$inline, this]);
  }
  ...
  _proto._initializeForm = function _initializeForm(form) {
    var $form = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(form);
    var formPrefix = $form.djangoFormPrefix();
    $form.addClass(this.opts.formClass);

    if ($form.hasClass('has_original')) {
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()('#id_' + formPrefix + 'DELETE:checked').toggleClass(this.opts.predeleteClass);
    }
    ...
    this.$inline.djangoFormsetForms().each(function () {
      ...
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(this).find(self.opts.removeButtonSelector)[showHideMethod]();
    });
  };
  ...
  _proto._bindEvents = function _bindEvents($el) {
    ...
    $el.find(this.opts.removeButtonSelector).filter(function () {
      return !_jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(this).closest('.djn-empty-form').length;
    }).off('click.djnesting').on('click.djnesting', function (e) {
      e.preventDefault();
      e.stopPropagation();
      var $form = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(this).closest(self.opts.formClassSelector);
      self.remove($form);
    });
    ...
    var deleteClickHandler = function deleteClickHandler(e) {
      ...
      var $form = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(this).closest(self.opts.formClassSelector);
      var $deleteInput = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()('#id_' + $form.djangoFormPrefix() + 'DELETE');
  ...
  _proto.remove = function remove(form) {
    ...
    _utils__WEBPACK_IMPORTED_MODULE_5__["default"].updatePositions(this.prefix);
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('djnesting:mutate', [this.$inline]); // Also fire using the events that were added in Django 1.9

    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('formset:removed', [$form, this.prefix]);
  };

  _proto.delete = function _delete(form) {
    var self = this,
        $form = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(form),
        formPrefix = $form.djangoFormPrefix(),
        $deleteInput = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()('#id_' + formPrefix + 'DELETE');
    ...
    $form.find('.djn-group').each(function () {
      var $childInline = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(this);
      var childFormset = $childInline.djangoFormset();
      $childInline.djangoFormsetForms().each(function () {
        if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(this).hasClass(self.opts.predeleteClass)) {
          _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(this).data('alreadyDeleted', true);
        } else {
    ...
    $form.find('.cropduster-form').each(function () {
      var formPrefix = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(this).djangoFormsetPrefix() + '-0-';
      var $deleteInput = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()('#id_' + formPrefix + 'DELETE');
      $deleteInput.attr('checked', 'checked');
    ...
    _utils__WEBPACK_IMPORTED_MODULE_5__["default"].updatePositions(this.prefix);
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('djnesting:mutate', [this.$inline]);
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('formset:deleted', [$form, this.prefix]);
  };
  ...
  _proto.undelete = function undelete(form) {
    ...
    $form.find('.djn-group').each(function () {
      ...
      var childFormset = $childInline.djangoFormset();
      $childInline.djangoFormsetForms().each(function () {
        if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(this).data('alreadyDeleted')) {
          _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(this).data('alreadyDeleted', false);
        } else {
    ...
    _utils__WEBPACK_IMPORTED_MODULE_5__["default"].updatePositions(this.prefix);
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('djnesting:mutate', [this.$inline]);
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('formset:undeleted', [$form, this.prefix]);
  };
  ...
  _proto.add = function add(spliceIndex) {
    ...
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('djnesting:beforeadded', [this.$inline, $form]);
    $form.removeClass(this.opts.emptyClass);
    $form.addClass('djn-item');
    $form.attr('id', $form.attr('id').replace('-empty', '-' + index));

    if (isNested) {
      $form.append(_utils__WEBPACK_IMPORTED_MODULE_5__["default"].createContainerElement());
    }

    _utils__WEBPACK_IMPORTED_MODULE_5__["default"].updateFormAttributes($form, new RegExp('([\\#_]|^)' + Object(_regexquote__WEBPACK_IMPORTED_MODULE_4__["default"])(this.prefix) + '\\-(?:__prefix__|empty)\\-', 'g'), '$1' + this.prefix + '-' + index + '-');
    ...
    if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default.a.isNumeric(spliceIndex)) {
      this.spliceInto($form, spliceIndex, true);
    } else {
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('djnesting:mutate', [this.$inline]);
    }

    if (grappelli__WEBPACK_IMPORTED_MODULE_6___default.a) {
      grappelli__WEBPACK_IMPORTED_MODULE_6___default.a.reinitDateTimeFields($form);
    }

    _utils__WEBPACK_IMPORTED_MODULE_5__["default"].DjangoInlines.initPrepopulatedFields($form);
    _utils__WEBPACK_IMPORTED_MODULE_5__["default"].DjangoInlines.reinitDateTimeShortCuts();
    _utils__WEBPACK_IMPORTED_MODULE_5__["default"].DjangoInlines.updateSelectFilter($form);
    _utils__WEBPACK_IMPORTED_MODULE_5__["default"].initRelatedFields(this.prefix);
    _utils__WEBPACK_IMPORTED_MODULE_5__["default"].initAutocompleteFields(this.prefix);

    if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default.a.fn.grp_collapsible) {
      var addBackMethod = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default.a.fn.addBack ? 'addBack' : 'andSelf';
      $form.find('.collapse')[addBackMethod]().grp_collapsible({
        ...
        on_toggle: function on_toggle() {
          _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('djnesting:toggle', [self.$inline]);
        }
      });
    }

    if (typeof _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default.a.fn.curated_content_type == 'function') {
      $form.find('.curated-content-type-select').each(function () {
        _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(this).curated_content_type();
      });
    }
    ...
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('djnesting:added', [this.$inline, $form]); // Also fire using the events that were added in Django 1.9

    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('formset:added', [$form, this.prefix]);
    return $form;
  };
  ...
  _proto._fillGap = function _fillGap(index, isInitial) {
    ...
    formsets.sort(function (a, b) {
      return _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(a).djangoFormIndex() - _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(b).djangoFormIndex();
    });
    ...
    var oldFormPrefixRegex = new RegExp('([\\#_]|^)' + Object(_regexquote__WEBPACK_IMPORTED_MODULE_4__["default"])(this.prefix + '-' + oldIndex) + '(?!\\-\\d)');
    $form.attr('id', this.prefix + '-' + index);
    _utils__WEBPACK_IMPORTED_MODULE_5__["default"].updateFormAttributes($form, oldFormPrefixRegex, '$1' + this.prefix + '-' + index); // Update prefixes on nested DjangoFormset objects
    ...
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('djnesting:attrchange', [this.$inline, $form]);
  ...
  _proto._makeRoomForInsert = function _makeRoomForInsert() {
    var initialFormCount = this.mgmtVal('INITIAL_FORMS'),
        ...
        $existingForm = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()('#' + this.prefix + '-' + gapIndex);

    if (!$existingForm.length) {
      return;
    }

    var oldFormPrefixRegex = new RegExp('([\\#_]|^)' + Object(_regexquote__WEBPACK_IMPORTED_MODULE_4__["default"])(this.prefix) + '-' + gapIndex + '(?!\\-\\d)');
    $existingForm.attr('id', this.prefix + '-' + totalFormCount);
    _utils__WEBPACK_IMPORTED_MODULE_5__["default"].updateFormAttributes($existingForm, oldFormPrefixRegex, '$1' + this.prefix + '-' + totalFormCount); // Update prefixes on nested DjangoFormset objects
    ...
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('djnesting:attrchange', [this.$inline, $existingForm]);
  };
  /**
  ...
  _proto.spliceInto = function spliceInto($form, index, isNewAddition) {
    ...
    if ($form.djangoFormsetPrefix() == this.prefix) {
      ...
      if (currentPosition === index || typeof index == 'undefined') {
        _utils__WEBPACK_IMPORTED_MODULE_5__["default"].updatePositions(newFormsetPrefix);
        return;
      }
      ...
      var $oldInline = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()('#' + oldFormsetPrefix + '-group');
      ...
      var oldFormPrefixRegex = new RegExp('([\\#_]|^)' + Object(_regexquote__WEBPACK_IMPORTED_MODULE_4__["default"])($form.attr('id')) + '(?!\\-\\d)');
      newIndex = isInitial ? initialFormCount : totalFormCount;
      $form.attr('id', newFormsetPrefix + '-' + newIndex);
      _utils__WEBPACK_IMPORTED_MODULE_5__["default"].updateFormAttributes($form, oldFormPrefixRegex, '$1' + newFormsetPrefix + '-' + newIndex); // Update prefixes on nested DjangoFormset objects
      ...
      _utils__WEBPACK_IMPORTED_MODULE_5__["default"].updatePositions(oldFormsetPrefix);
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('djnesting:mutate', [$oldInline]);
    }
...
_jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default.a.fn[pluginName] = function () {
  var options, fn, args;
  var $el = this.eq(0);

  if (arguments.length === 0 || arguments.length === 1 && _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default.a.type(arguments[0]) != 'string') {
    options = arguments[0];
  ...
  fn = arguments[0];
  args = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default.a.makeArray(arguments).slice(1);
...
/* harmony import */ var _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4__);
...
_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.fn.djnData = function (name) {
  var inlineFormsetData = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this).data('inlineFormset') || {},
...
_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.fn.djangoPrefixIndex = function () {
...
_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.fn.djangoFormPrefix = function () {
...
_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.fn.djangoFormIndex = function () {
  var prefixIndex = this.djangoPrefixIndex();
  return !prefixIndex || !prefixIndex[1] ? null : parseInt(prefixIndex[1], 10);
};

_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.fn.djangoFormsetPrefix = function () {
  var prefixIndex = this.djangoPrefixIndex();
...
_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.fn.djangoFormsetForms = function () {
  var forms = [];
  this.each(function () {
    var $this = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this),
        formsetPrefix = $this.djangoFormsetPrefix(),
        $group = formsetPrefix ? _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()('#' + formsetPrefix + '-group') : null,
        $forms;
    ...
    var sortedForms = $forms.toArray().sort(function (a, b) {
      return _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(a).djangoFormIndex() - _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(b).djangoFormIndex;
    });
...
if (typeof _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.djangoFormField != 'function') {
  _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.djangoFormField = function (fieldName, prefix, index) {
    var $empty = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()([]),
        matches;
    ...
    if (fieldName == '*') {
      return _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()('*[name^="' + namePrefix + '"]').filter(function () {
        var fieldPart = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this).attr('name').substring(namePrefix.length);
        return fieldPart.indexOf('-') === -1;
      });
    }

    var $field = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()('#id_' + namePrefix + fieldName);

    if (!$field.length && (fieldName == 'pk' || fieldName == 'position')) {
      var $group = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()('#' + prefix + '-group'),
      ...
      $field = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()('#id_' + namePrefix + fieldName);
    }
...
if (typeof _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.fn.djangoFormField != 'function') {
  /**
   ...
   */
  _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.fn.djangoFormField = function (fieldName, index) {
    ...
    return _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.djangoFormField(fieldName, prefix, index);
  };
}

if (typeof _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.fn.filterDjangoField != 'function') {
  var djRegexCache = {};

  _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.fn.filterDjangoField = function (prefix, fieldName, index) {
    ...
    if (typeof index != 'undefined') {
      ...
      if (typeof index == 'number' && !isNaN(index)) {
        ...
        $field = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()('#' + fieldId);
      }
    } else {
    ...
    if (!$field.length && (fieldName == 'pk' || fieldName == 'position')) {
      fieldNameData = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()('#' + prefix + '-group').djnData('fieldNames') || {};

      if (typeof fieldNameData[fieldName] && fieldNameData[fieldName] != fieldName) {
        $field = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this).filterDjangoField(prefix, fieldNameData[fieldName], index);
      }
    }
...
if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui === undefined) {
  var jQuery = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a;
...
_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.widget("ui.djnsortable", _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.mouse, {
  version: "@VERSION",
  ...
  _setOption: function _setOption(key, value) {
    if (key === "disabled") {
      ...
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.Widget.prototype._setOption.apply(this, arguments);
    }
  },
  _mouseCapture: function _mouseCapture(event, overrideHandle) {
    ...
    var currentItem = null,
        nodes = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(event.target).parents().each(function () {
      if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.data(this, that.widgetName + '-item') == that) {
        currentItem = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this);
        return false;
      }
    });
    if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.data(event.target, that.widgetName + '-item') == that) currentItem = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(event.target);
    if (!currentItem) return false;

    if (this.options.handle && !overrideHandle) {
      var validHandle = false;
      var addBackMethod = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.fn.addBack ? 'addBack' : 'andSelf';
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this.options.handle, currentItem).find("*")[addBackMethod]().each(function () {
  ...
  _mouseStart: function _mouseStart(event, overrideHandle, noActivation) {
    ...
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.extend(this.offset, {
      click: {
    ...
    if (o.cursor) {
      // cursor option
      if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()('body').css("cursor")) this._storedCursor = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()('body').css("cursor");
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()('body').css("cursor", o.cursor);
    }
    ...
    if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.ddmanager) _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.ddmanager.current = this;
    if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.ddmanager && !o.dropBehaviour) _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.ddmanager.prepareOffsets(this, event);
    this.dragging = true;
  ...
  _mouseDrag: function _mouseDrag(event) {
    ...
    if (this.options.scroll) {
      ...
      if (this.scrollParent[0] != document && this.scrollParent[0].tagName != 'HTML') {
        ...
        if (event.pageY - _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document).scrollTop() < o.scrollSensitivity) scrolled = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document).scrollTop(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document).scrollTop() - o.scrollSpeed);else if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(window).height() - (event.pageY - _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document).scrollTop()) < o.scrollSensitivity) scrolled = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document).scrollTop(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document).scrollTop() + o.scrollSpeed);
        if (event.pageX - _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document).scrollLeft() < o.scrollSensitivity) scrolled = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document).scrollLeft(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document).scrollLeft() - o.scrollSpeed);else if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(window).width() - (event.pageX - _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document).scrollLeft()) < o.scrollSensitivity) scrolled = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document).scrollLeft(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document).scrollLeft() + o.scrollSpeed);
      }

      if (scrolled !== false && _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.ddmanager && !o.dropBehaviour) _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.ddmanager.prepareOffsets(this, event);
    ...
    for (var i = this.items.length - 1; i >= 0; i--) {
      ...
      && !_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.contains(this.placeholder[0], itemElement) //no action if the item moved is the parent of the item checked
      && (this.options.type == 'semi-dynamic' ? !_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.contains(this.element[0], itemElement) : true) //&& itemElement.parentNode == this.placeholder[0].parentNode // only rearrange items within the same container
      ) {
    ...
    if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.ddmanager) _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.ddmanager.drag(this, event); //Call callbacks
  ...
  _mouseStop: function _mouseStop(event, noPropagation) {
    ...
    if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.ddmanager && !this.options.dropBehaviour) _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.ddmanager.drop(this, event);

    if (this.options.revert) {
      var that = this;
      var cur = this.placeholder.offset();
      this.reverting = true;
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this.helper).animate({
  ...
  cancel: function cancel() {
    ...
    if (this.placeholder) {
      ...
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.extend(this, {
        helper: null,
        dragging: false,
        reverting: false,
        _noFinalSort: null
      ...
      if (this.domPosition.prev) {
        _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this.domPosition.prev).after(this.currentItem);
      } else {
        _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this.domPosition.parent).prepend(this.currentItem);
      }
    }
  ...
  serialize: function serialize(o) {
    ...
    var str = [];
    o = o || {};
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(items).each(function () {
      var res = (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(o.item || this).attr(o.attribute || 'id') || '').match(o.expression || /(.+)[-=_](.+)/);
  ...
  toArray: function toArray(o) {
    ...
    o = o || {};
    items.each(function () {
      ret.push(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(o.item || this).attr(o.attribute || 'id') || '');
    });
    return ret;
  },
  ...
  _getItemsAsjQuery: function _getItemsAsjQuery(connected) {
    ...
    if (connectWith && connected) {
      for (var i = connectWith.length - 1; i >= 0; i--) {
        var cur = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(connectWith[i]);

        for (var j = cur.length - 1; j >= 0; j--) {
          var inst = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.data(cur[j], this.widgetName);

          if (inst && inst != this && !inst.options.disabled) {
            queries.push([_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.isFunction(inst.options.items) ? inst.options.items.call(inst.element) : _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(inst.options.items, inst.element).not(".ui-sortable-helper").not('.ui-sortable-placeholder'), inst]);
          }
        }
    ...
    queries.push([_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.isFunction(this.options.items) ? this.options.items.call(this.element, null, {
      options: this.options,
      item: this.currentItem
    }) : _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this.options.items, this.element).not(".ui-sortable-helper").not('.ui-sortable-placeholder'), this]);
    ...
    ;
    return _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(items);
  },
  _removeCurrentsFromItems: function _removeCurrentsFromItems() {
    var list = this.currentItem.find(":data(" + this.widgetName + "-item)");
    this.items = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.grep(this.items, function (item) {
  ...
  _refreshItems: function _refreshItems(event) {
    ...
    var queries = [[_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.isFunction(this.options.items) ? this.options.items.call(this.element[0], event, {
      item: this.currentItem
    }) : _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this.options.items, this.element), this]];
    ...
    if (connectWith && this.ready) {
      ...
      for (var i = connectWith.length - 1; i >= 0; i--) {
        ...
        for (var j = cur.length - 1; j >= 0; j--) {
          ...
          if (inst && inst != this && !inst.options.disabled) {
            queries.push([_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.isFunction(inst.options.items) ? inst.options.items.call(inst.element[0], event, {
              item: this.currentItem
            }) : _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(inst.options.items, inst.element), inst]);
    ...
    for (var i = queries.length - 1; i >= 0; i--) {
      ...
      for (var j = 0, queriesLength = _queries.length; j < queriesLength; j++) {
        var item = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(_queries[j]);
  ...
  refreshPositions: function refreshPositions(fast) {
    ...
    for (var i = this.items.length - 1; i >= 0; i--) {
      ...
      var t = this.options.toleranceElement ? _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this.options.toleranceElement, item.item) : item.item;
  ...
  _createPlaceholder: function _createPlaceholder(that) {
    ...
    if (!o.placeholder || o.placeholder.constructor == String) {
      ...
      o.placeholder = {
        element: function element() {
          var el = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document.createElement(that.currentItem[0].nodeName)).addClass(className || that.currentItem[0].className + " ui-sortable-placeholder").removeClass("ui-sortable-helper")[0];
    ...
    that.placeholder = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(o.placeholder.element.call(that.element, that.currentItem)); //Append it after the actual current item
  ...
  _contactContainers: function _contactContainers(event) {
    ...
    for (var i = this.containers.length - 1; i >= 0; i--) {
      ...
      if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.contains(this.currentItem[0], this.containers[i].element[0])) continue;

      if (this._intersectsWith(this.containers[i].containerCache)) {
        // if we've already found a container and it's more "inner" than this, then continue
        if (innermostContainer && _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.contains(this.containers[i].element[0], innermostContainer.element[0])) continue;
    ...
    if (this.containers.length === 1) {
      ...
      for (var j = this.items.length - 1; j >= 0; j--) {
        if (!_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.contains(this.containers[innermostIndex].element[0], this.items[j].item[0])) continue;
  ...
  _createHelper: function _createHelper(event) {
    var o = this.options;
    var helper = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.isFunction(o.helper) ? _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(o.helper.apply(this.element[0], [event, this.currentItem])) : o.helper == 'clone' ? this.currentItem.clone() : this.currentItem;
    if (!helper.parents('body').length) //Add the helper to the DOM if that didn't happen already
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(o.appendTo != 'parent' ? o.appendTo : this.currentItem[0].parentNode)[0].appendChild(helper[0]);
  ...
  _adjustOffsetFromHelper: function _adjustOffsetFromHelper(obj) {
    ...
    if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.isArray(obj)) {
      obj = {
        left: +obj[0],
        top: +obj[1] || 0
      };
  ...
  _getParentOffset: function _getParentOffset() {
    ...
    if (this.cssPosition == 'absolute' && this.scrollParent[0] != document && _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.contains(this.scrollParent[0], this.offsetParent[0])) {
      po.left += this.scrollParent.scrollLeft();
      po.top += this.scrollParent.scrollTop();
    }

    if (this.offsetParent[0] == document.body || //This needs to be actually done for all browsers, since pageX/pageY includes this information
    this.offsetParent[0].tagName && this.offsetParent[0].tagName.toLowerCase() == 'html' && _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.ie) //Ugly IE fix
      po = {
        top: 0,
        left: 0
      };
  ...
  _setContainment: function _setContainment() {
    ...
    if (o.containment == 'document' || o.containment == 'window') this.containment = [0 - this.offset.relative.left - this.offset.parent.left, 0 - this.offset.relative.top - this.offset.parent.top, _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(o.containment == 'document' ? document : window).width() - this.helperProportions.width - this.margins.left, (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(o.containment == 'document' ? document : window).height() || document.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top];

    if (!/^(document|window|parent)$/.test(o.containment)) {
      var ce = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(o.containment)[0];
      var co = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(o.containment).offset();
      var over = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(ce).css("overflow") != 'hidden';
      this.containment = [co.left + (parseInt(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(ce).css("borderLeftWidth"), 10) || 0) + (parseInt(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(ce).css("paddingLeft"), 10) || 0) - this.margins.left, co.top + (parseInt(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(ce).css("borderTopWidth"), 10) || 0) + (parseInt(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(ce).css("paddingTop"), 10) || 0) - this.margins.top, co.left + (over ? Math.max(ce.scrollWidth, ce.offsetWidth) : ce.offsetWidth) - (parseInt(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(ce).css("borderLeftWidth"), 10) || 0) - (parseInt(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(ce).css("paddingRight"), 10) || 0) - this.helperProportions.width - this.margins.left, co.top + (over ? Math.max(ce.scrollHeight, ce.offsetHeight) : ce.offsetHeight) - (parseInt(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(ce).css("borderTopWidth"), 10) || 0) - (parseInt(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(ce).css("paddingBottom"), 10) || 0) - this.helperProportions.height - this.margins.top];
    }
  },
  _convertPositionTo: function _convertPositionTo(d, pos) {
    ...
    var o = this.options,
        scroll = this.cssPosition == 'absolute' && !(this.scrollParent[0] != document && _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent,
  ...
  _clear: function _clear(event, noPropagation) {
    ...
    if (this._storedCursor) _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()('body').css("cursor", this._storedCursor); //Reset cursor
  ...
  _trigger: function _trigger() {
    if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.Widget.prototype._trigger.apply(this, arguments) === false) {
      this.cancel();
    }
  },
  ...
  _uiHash: function _uiHash(_inst) {
    ...
    return {
      helper: inst.helper,
      placeholder: inst.placeholder || _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()([]),
...
if (typeof _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.fn.nearest != 'function') {
  /**
   ...
   */
  _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.fn.nearest = function (selector) {
    var nearest = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()([]),
        node = this,
        distance = 10000;
    node.find(selector).each(function () {
      var n = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this),
...
var createChildNestedSortable = function createChildNestedSortable(parent, childContainer) {
  ...
  var $childContainer = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(childContainer),
      options = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.extend({}, parent.options);
...
_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.widget("ui.nestedSortable", _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.djnsortable, {
  options: {
    tabSize: 20,
    ...
    createContainerElement: function createContainerElement(parent) {
      return _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document.createElement('ol'));
    },
  ...
  _createWidget: function _createWidget(options, element) {
    var $element = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(element || this.defaultElement || this),
        dataOptions = $element.data('djnsortableOptions');
    element = $element[0];

    if (dataOptions) {
      options = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.extend({}, options, dataOptions);
    }

    return _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.djnsortable.prototype._createWidget.call(this, options, element);
  },
  _create: function _create() {
    ...
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.djnsortable.prototype._create.apply(this, arguments);

    this._connectWithMap = {};
    var self = this,
        o = this.options,
        $document = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document);
    ...
    if (!originalConnectWith || typeof originalConnectWith == 'string') {
      ...
      if (typeof originalConnectWith == 'string') {
        ...
        for (var i = 0; i < connected.length; i++) {
          this.addToConnectWith(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(connected[i]));
        }
      ...
      this.element.find(o.containerElementSelector + ':not(.subarticle-wrapper)').each(function (i, el) {
        if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(el).closest('[data-inline-formset]').attr('id').indexOf('-empty') > -1) {
          return;
        }
  ...
  addToConnectWith: function addToConnectWith(element) {
    var self = this,
        $element = typeof element.selector != 'undefined' ? element : _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(element),
        uniqueId;

    if ($element.length > 1) {
      $element.each(function (i, el) {
        self.addToConnectWith(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(el));
      });
      return;
    }
  ...
  _destroy: function _destroy() {
    ...
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(document).unbind('.nestedSortable');
    return _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.djnsortable.prototype.destroy.apply(this, arguments);
  },
  ...
  _intersectsWithPointer: function _intersectsWithPointer(item) {
    var itemElement = item.item[0],
        o = this.options,
        intersection = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.djnsortable.prototype._intersectsWithPointer.apply(this, arguments);
    ...
    var $itemElement = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(itemElement);
    ...
    if (o.fixedNestingDepth && this._getLevel(this.currentItem) === 1 + this._getLevel($itemElement)) {
      $itemElement = function () {
        ...
        return _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()($childItems[0]);
      }();
    ...
    && this.placeholder[intersection == 1 ? "next" : "prev"]()[0] != itemElement //no useless actions that have been done before
    && !_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.contains(this.placeholder[0], itemElement) //no action if the item moved is the parent of the item checked
    && (this.options.type == 'semi-dynamic' ? !_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.contains(this.element[0], itemElement) : true) && (!o.keepInParent || itemElement.parentNode == this.placeholder[0].parentNode) //only rearrange items within the same container
  ...
  _contactContainers: function _contactContainers(event) {
    ...
    if (this.options.fixedNestingDepth) {
      return _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.djnsortable.prototype._contactContainers.apply(this, arguments);
    }
    ...
    var previousItem = this.placeholder[0].previousSibling ? _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this.placeholder[0].previousSibling) : null;
    ...
    if (previousItem != null) {
      while (!previousItem.is(this.options.listItemSelector) || previousItem[0] == this.currentItem[0] || previousItem[0] == this.helper[0]) {
        if (previousItem[0].previousSibling) {
          previousItem = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(previousItem[0].previousSibling);
        } else {
          previousItem = null;
          break;
        }
    ...
    var nextItem = this.placeholder[0].nextSibling ? _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this.placeholder[0].nextSibling) : null;

    if (nextItem != null) {
      while (!nextItem.is(this.options.listItemSelector) || nextItem[0] == this.currentItem[0] || nextItem[0] == this.helper[0]) {
        if (nextItem[0].nextSibling) {
          nextItem = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(nextItem[0].nextSibling);
        } else {
          nextItem = null;
          break;
        }
    ...
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.djnsortable.prototype._contactContainers.call(this, event);
  },
  _rearrange: function _rearrange(event, item, a, hardRefresh) {
    ...
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.djnsortable.prototype._rearrange.apply(this, arguments);
  },
  _convertPositionTo: function _convertPositionTo(d, pos) {
    // Cache the top offset before rearrangement
    this.previousTopOffset = this.placeholder.offset().top;
    return _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.djnsortable.prototype._convertPositionTo.apply(this, arguments);
  },
  _clear: function _clear() {
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.djnsortable.prototype._clear.apply(this, arguments); // If lastRearrangedElement exists and is still attached to the document
  ...
  _mouseStop: function _mouseStop(event, noPropagation) {
    ...
    if (this.beyondMaxLevels) {
      ...
      if (this.domPosition.prev) {
        _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this.domPosition.prev).after(this.placeholder);
      } else {
        _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this.domPosition.parent).prepend(this.placeholder);
      }
    ...
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.djnsortable.prototype._mouseStop.apply(this, arguments);
  },
  toArray: function toArray(o) {
    o = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.extend(true, {}, this.options, o || {});
    ...
    ret.push({
      ...
      "depth": sDepth,
      "left": '1',
      "right": (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(o.listItemSelector, this.element).length + 1) * 2
    });
    ...
    var _recursiveArray = function _recursiveArray(item, depth, left) {
      var right = left + 1,
          id,
          pid;
      var $childItems = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(item).children(o.containerElementSelector).find(o.items);

      if ($childItems.length > 0) {
        depth++;
        $childItems.each(function () {
          right = _recursiveArray(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this), depth, right);
        });
        depth--;
      }

      id = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(item).attr(o.attribute || 'id').match(o.expression || /(.+)[-=_](.+)/);

      if (depth === sDepth + 1) {
        pid = o.rootID;
      } else {
        var parentItem = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(item).parent(o.containerElementSelector).parent(o.items).attr(o.attribute || 'id').match(o.expression || /(.+)[-=_](.+)/);
        pid = parentItem[2];
      }
    ...
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this.element).children(o.listItemSelector).each(function () {
  ...
  _clearEmpty: function _clearEmpty(item) {
    ...
    var $item = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(item);
  ...
  _getChildLevels: function _getChildLevels(parent, depth) {
    var self = this,
        ...
        result = 0;
    depth = depth || 0;
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(parent).nearest(o.containerElementSelector).find(o.items).each(function (index, child) {
      if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(child).is('.djn-no-drag,.djn-thead')) {
        return;
      }
  ...
  _isAllowed: function _isAllowed(parentItem, level, levels) {
    var o = this.options,
        isRoot = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(this.domPosition.parent).hasClass('ui-sortable') ? true : false; // this takes into account the maxLevels set to the recipient list
    ...
    if (parentItem && typeof parentItem == 'object' && typeof parentItem.selector == 'undefined') {
      parentItem = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(parentItem);
    }
  ...
  _connectWith: function _connectWith() {
    var origConnectWith = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.djnsortable.prototype._connectWith.apply(this, arguments),
        connectWith = [];

    var self = this;

    for (var i = 0; i < origConnectWith.length; i++) {
      var $elements = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(origConnectWith[i]);
      $elements.each(function (j, el) {
        if (el == self.element[0]) {
          return;
        }

        if (!self.options.canConnectWith(self.element, _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(el), self)) {
          return;
        }
  ...
  createContainerElement: function createContainerElement(parent) {
    ...
    return _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default()(newContainer);
  }
});
_jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.nestedSortable.prototype.options = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.extend({}, _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.djnsortable.prototype.options, _jquery_shim_js__WEBPACK_IMPORTED_MODULE_4___default.a.ui.nestedSortable.prototype.options);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return regexQuote; });
...
/*!***********************************************************************!*\
  !*** ./nested_admin/static/nested_admin/src/nested-admin/sortable.js ***!
  \***********************************************************************/
/*! exports provided: updatePositions, createSortable */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updatePositions", function() { return updatePositions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createSortable", function() { return createSortable; });
/* harmony import */ var core_js_modules_es6_regexp_replace__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es6.regexp.replace */ "./node_modules/core-js/modules/es6.regexp.replace.js");
/* harmony import */ var core_js_modules_es6_regexp_replace__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_regexp_replace__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es6_array_find__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es6.array.find */ "./node_modules/core-js/modules/es6.array.find.js");
/* harmony import */ var core_js_modules_es6_array_find__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_array_find__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _regexquote__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./regexquote */ "./nested_admin/static/nested_admin/src/nested-admin/regexquote.js");
/* harmony import */ var _jquery_ui_nestedsortable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./jquery.ui.nestedsortable */ "./nested_admin/static/nested_admin/src/nested-admin/jquery.ui.nestedsortable.js");
...
function updatePositions(prefix) {
  var position = 0,
      count = 1,
      $group = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()('#' + prefix + '-group'),
  ...
  if (parentPrefix) {
    var $parentGroup = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()('#' + parentPrefix + '-group');
  ...
  $group.find('.djn-inline-form').each(function () {
    ...
    var regex = new RegExp('^(?:id_)?' + Object(_regexquote__WEBPACK_IMPORTED_MODULE_4__["default"])(prefix) + '\\-\\d+$');
    ...
    var $this = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(this),
    ...
    $fields.each(function () {
      var $field = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(this);
      ...
      if (hasValue && _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default.a.inArray(fieldName, sortableExcludes) === -1) {
        setPosition = true;
      }
    });
  ...
  return $group.find('> .djn-items, > .djn-fieldset > .djn-items, > .tabular > .module > .djn-items').nestedSortable({
    ...
    placeholder: {
      element: function element($currentItem) {
        var el = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document.createElement($currentItem[0].nodeName)).addClass($currentItem[0].className + ' ui-sortable-placeholder').removeClass('ui-sortable-helper')[0];
        ...
        if ($currentItem.is('.djn-tbody')) {
          ...
          var $tr = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()("<" + trTagName + "></" + trTagName + ">");
          ...
          $originalTr.children('.djn-td').each(function (i, td) {
            numColumns += parseInt(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(td).attr('colspan'), 10) || 1;
          });
          $tr.append(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()("<" + tdTagName + " colspan=\"" + numColumns + "\" class=\"djn-td grp-td\"></" + tdTagName + ">"));
          el.appendChild($tr[0]);
        }
    ...
    receive: function receive(event, ui) {
      var $inline = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(this).closest('.djn-group');
    ...
    update: function update(event, ui) {
      ...
      var groupId = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(event.target).closest('.djn-group').attr('id'),
          $form = ui.item,
      ...
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()(document).trigger('djnesting:mutate', [_jquery_shim_js__WEBPACK_IMPORTED_MODULE_3___default()('#' + $form.djangoFormsetPrefix() + '-group')]);
    }
  });
}
...
/* harmony import */ var _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_jquery_shim_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _jquery_djnutils_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./jquery.djnutils.js */ "./nested_admin/static/nested_admin/src/nested-admin/jquery.djnutils.js");
/* harmony import */ var _sortable__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./sortable */ "./nested_admin/static/nested_admin/src/nested-admin/sortable.js");
...
/* harmony import */ var django_date_time_shortcuts__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! django/date-time-shortcuts */ "django/date-time-shortcuts");
/* harmony import */ var django_date_time_shortcuts__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(django_date_time_shortcuts__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var django_select_filter__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! django/select-filter */ "django/select-filter");
/* harmony import */ var django_select_filter__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(django_select_filter__WEBPACK_IMPORTED_MODULE_10__);
...
DJNesting.regexQuote = _regexquote__WEBPACK_IMPORTED_MODULE_8__["default"];
DJNesting.createSortable = _sortable__WEBPACK_IMPORTED_MODULE_7__["createSortable"];
DJNesting.updatePositions = _sortable__WEBPACK_IMPORTED_MODULE_7__["updatePositions"];
/**
...
DJNesting.updateFormAttributes = function ($elem, search, replace, selector) {
  ...
  var addBackMethod = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default.a.fn.addBack ? 'addBack' : 'andSelf';
  $elem.find(selector)[addBackMethod]().each(function () {
    var $node = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default()(this),
        attrs = ['id', 'name', 'for', 'href', 'class', 'onclick'];
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default.a.each(attrs, function (i, attrName) {
  ...
  $elem.find('.prepopulated_field').each(function () {
    var $node = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default()(this);
    var dependencyIds = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default.a.makeArray($node.data('dependency_ids') || []);
    $node.data('dependency_ids', _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default.a.map(dependencyIds, function (id) {
...
DJNesting.initRelatedFields = function (prefix, groupData) {
  ...
  var $inline = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default()('#' + prefix + '-group');
  ...
  $inline.djangoFormsetForms().each(function (i, form) {
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default.a.each(lookupFields.fk || [], function (i, fk) {
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default()(form).djangoFormField(fk).each(function () {
        _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default()(this).grp_related_fk({
          lookup_url: lookupUrls.related
        });
      });
    });
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default.a.each(lookupFields.m2m || [], function (i, m2m) {
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default()(form).djangoFormField(m2m).each(function () {
        _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default()(this).grp_related_m2m({
          lookup_url: lookupUrls.m2m
        });
      });
    });
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default.a.each(lookupFields.generic || [], function () {
      var _this = this,
          contentType = _this[0],
          objectId = _this[1];

      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default()(form).djangoFormField(objectId).each(function () {
        var $this = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default()(this);
  ...
  $inline.djangoFormsetForms().each(function (i, form) {
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default.a.each(lookupFields.fk || [], function (i, fk) {
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default()(form).djangoFormField(fk).each(function () {
        ...
        if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default()('#' + id + '-autocomplete').length) {
          return;
        }
    ...
    _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default.a.each(lookupFields.generic || [], function () {
      ...
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default()(form).djangoFormField(objectId).each(function () {
        ...
        if (_jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default()('#' + $this.attr('id') + '-autocomplete').length) {
          return;
        }
...
DJNesting.DjangoInlines = {
  initPrepopulatedFields: function initPrepopulatedFields(row) {
    row.find('.prepopulated_field').each(function () {
      var field = _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default()(this),
      ...
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default.a.each(dependencyList, function (i, fieldName) {
  ...
  reinitDateTimeShortCuts: function reinitDateTimeShortCuts() {
    ...
    if (typeof django_date_time_shortcuts__WEBPACK_IMPORTED_MODULE_9___default.a !== 'undefined') {
      _jquery_shim_js__WEBPACK_IMPORTED_MODULE_5___default()('.datetimeshortcuts').remove();
      django_date_time_shortcuts__WEBPACK_IMPORTED_MODULE_9___default.a.init();
    }
  },
  updateSelectFilter: function updateSelectFilter($form) {
    // If any SelectFilter widgets are a part of the new form,
    // instantiate a new SelectFilter instance for it.
    if (typeof django_select_filter__WEBPACK_IMPORTED_MODULE_10___default.a !== 'undefined') {
      $form.find('.selectfilter').each(function (index, value) {
        var namearr = value.name.split('-');
        django_select_filter__WEBPACK_IMPORTED_MODULE_10___default.a.init(value.id, namearr[namearr.length - 1], false, DJNesting.adminStaticPrefix);
      });
      $form.find('.selectfilterstacked').each(function (index, value) {
        var namearr = value.name.split('-');
        django_select_filter__WEBPACK_IMPORTED_MODULE_10___default.a.init(value.id, namearr[namearr.length - 1], true, DJNesting.adminStaticPrefix);
      });
    }
  }
};
...
/***/ 0:
/*!***********************************************************************************************************************************!*\
  !*** multi ./nested_admin/static/nested_admin/src/nested-admin/index.js ./nested_admin/static/nested_admin/src/nested_admin.scss ***!
  \***********************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/fdintino/Sites/cms/src/django-nested-admin/nested_admin/static/nested_admin/src/nested-admin/index.js */"./nested_admin/static/nested_admin/src/nested-admin/index.js");
module.exports = __webpack_require__(/*! /Users/fdintino/Sites/cms/src/django-nested-admin/nested_admin/static/nested_admin/src/nested_admin.scss */"./nested_admin/static/nested_admin/src/nested_admin.scss");
...
(function() { module.exports = this["DateTimeShortcuts"]; }());
...
(function() { module.exports = this["SelectFilter"]; }());
...
(function() { module.exports = this["grappelli"]; }());
